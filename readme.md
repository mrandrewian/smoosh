...
```bash
git clone https://github.com/mrandrewian/phaser3-parcel-template.git
```

This will create a folder named `phaser3-typescript-parcel-template`. You can specify a different folder name like this:

```bash
git clone https://github.com/mrandrewian/phaser3-parcel-template.git my-folder-name
```
...
Other than that there is no opinion on how you should structure your project. There is a `scenes` folder in `src` where the `Game.ts` lives but you can do whatever you want.
